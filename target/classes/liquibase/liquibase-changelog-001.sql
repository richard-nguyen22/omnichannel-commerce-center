...
--changeset Tuan:0001-create-user_login
...
insert into user_login(guid, user_email, user_name, password, status)
values("00000000-0000-0000-0000-000000000000", "richard_ngt22@gmail.com", ""System Default User", "IAMSuperUser#1")
